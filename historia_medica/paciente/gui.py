...
from modelo.historia_medica import historiaMedica, guardarHistoria, listarHistoria, eliminarHistoria, editarHistoria
...
class Frame(tk.Frame):
    ...
    def vistaCalendario(self):
        ...
        self.topCalendario.iconbitmap('historia_medica/img/clinica.ico')
        self.topCalendario.config(bg='#CDD8FF')

        self.svCalendario = StringVar()
        self.svCalendario.set("01/01/1930")
    ...
    def historiaMedica(self):
        ...
        try:
            ...
            self.topHistoriaMedica.iconbitmap('historia_medica/img/clinica.ico')
    ...
    def topAgregarHistoria(self):
        ...
        self.topAHistoria.iconbitmap('historia_medica/img/clinica.ico')
    ...
    def topEditarHistorialMedico(self):
        try:
            ...
            self.topEditarHistoria.iconbitmap('historia_medica/img/clinica.ico')
